...
import { AppBar, Toolbar, TextField, Button, InputAdornment,IconButton } from '@mui/material';
...
const TopBar = ({ showLogin, setShowLogin, onSearch,onSuccessfulLogin,bagCount,setBagCount,openCart }) => {
  ...
  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }} onClick={handleSignInClick}>
    <IconButton style={{ padding: 0, marginBottom: '4px', marginLeft: '16px'  }}>
  ...
  {isLoggedIn && (  // Shopping Bag icon on the right
    <div style={{ marginLeft: '96px' }}> {/* Adjust this margin for more gap */}
      ...
      <Login open={showLogin || isSignOut} 
